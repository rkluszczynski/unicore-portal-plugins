 ...
 */
final
public class FileFragmentReaderHelper {
    ...
    private static String readGridFileFragment(EndpointReferenceType gridFileEpr, long startByte, long endByte) {
        ...
        SupportsPartialRead partialRead = (SupportsPartialRead) transferClient;
    ...
    private FileFragmentReaderHelper() {
    }

    private static final Logger logger = Logger.getLogger(FileFragmentReaderHelper.class);
}
